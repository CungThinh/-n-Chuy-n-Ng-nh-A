...
import { Create, SimpleForm, ReferenceInput, NumberInput, TextInput, DateInput, SelectInput } from 'react-admin';
...
export const PaymentList = (props) => (
    <List {...props}>
        <Datagrid rowClick="edit">
            ...
            <ReferenceField source="bookingId" reference="bookings" label="Booking ID">
                <TextField source="id" />
            </ReferenceField>
